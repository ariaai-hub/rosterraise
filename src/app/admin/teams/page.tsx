  ...
  const handleApprove = async (team: Team) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Show store URL to admin
        alert(`Team approved! Store URL: /store/${data.team.slug}`);
      } else {
          ...
          <table className="w-full">
            <thead>
              <tr style={{ backgroundColor: '#0A0A0A' }}>
                ...
                <th className="px-6 py-4 text-right text-sm font-medium" style={{ color: '#888888' }}>
                  Actions
                </th>
              </tr>
            </thead>
              ...
              {loading ? (
                ...
                teams
                  ...
                  .map((team) => {
                    ...
                    return (
                      <tr key={team.id} className="hover:bg-opacity-50" style={{ backgroundColor: 'transparent' }}>
                        ...
                        <td className="px-6 py-4">
                          {coach ? (
                            ...
                            <span style={{ color: '#888888' }}>No coach</span>
                          )}
                        </td>
                        <td className="px-6 py-4">
                          <span
          ...
          >
            <div className="flex items-start justify-between mb-6">
              <div>
                ...
                <p className="text-gray-500 mt-1">{selectedTeam.sport}</p>
              </div>
              <button
                onClick={() => setSelectedTeam(null)}
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                >
                  ...
                  <p className="font-medium truncate" style={{ color: '#E63946' }}>
